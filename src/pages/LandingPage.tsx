                      ...
                      <div className="flex-1 p-4 flex flex-col justify-between">
                        <div className="grid grid-cols-2 gap-x-2 gap-y-3.5 text-left">
                          ...
                          <div className="min-w-0">
                            ...
                            <span className="block text-[9px] text-slate-500 font-extrabold truncate uppercase tracking-widest">Crew-Event</span>
                          </div>
                        </div>
                        ...
                        <div className="relative my-3 shrink-0">
                          ...
                          <div className="absolute left-[-22px] top-[-8px] w-4 h-4 bg-black rounded-full z-10" />
                          <div className="absolute right-[-22px] top-[-8px] w-4 h-4 bg-black rounded-full z-10" />
                        </div>
              ...
              <div className="flex gap-1.5 mt-3 justify-center items-center">
                {events.map((_, idx) => (
                  <button
                    ...
                    className={`w-1.5 h-1.5 rounded-full transition-all duration-300 ${idx === carouselIndex ? 'w-4.5 bg-white' : 'bg-slate-700'}`}
      ...
      <section className="pt-10 border-t border-slate-900/60 max-w-xl mx-auto text-center space-y-6">
        <div className="flex flex-col items-center gap-4">
          <Button
            ...
            className="bg-black hover:bg-slate-950 border border-slate-750 text-white font-bold px-6 py-2.5 rounded-xl text-xs flex items-center gap-2 shadow-md transition-all active:scale-[0.98] w-fit cursor-pointer"
          >
          ...
          <div className="w-full max-w-sm space-y-2 mt-2 pt-3 border-t border-slate-800/80">
            {newsletterSubmitted ? (
              <p className="text-xs text-white font-semibold bg-slate-900 border border-slate-800 py-2.5 px-4 rounded-xl text-center animate-fade-in">
              ...
              <form onSubmit={handleNewsletterSubmit} className="flex gap-2">
                <input
                  ...
                  required
                  className="flex-1 bg-slate-950 border border-slate-800 focus:border-white rounded-xl px-4 py-2.5 text-base text-white placeholder-slate-600 outline-none transition-all"
                />
                <Button
                  type="submit"
                  variant="outline"
                  className="bg-white hover:bg-slate-200 text-black border border-white rounded-xl text-xs font-bold px-4 py-2.5 transition-all cursor-pointer"
                >
                  Anmelden
                </Button>
              </form>
